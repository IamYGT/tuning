              ...
              <div className="grid grid-cols-4 gap-3 sm:gap-4 mt-8">
                {flags.slice(0, 8).map((flag) => (
                  <div key={flag.code} className="flex items-center justify-center">
                    <div className="w-12 h-8 sm:w-14 sm:h-10 relative overflow-hidden rounded-md border border-gray-700 hover:border-custom-red transition-all cursor-pointer">
                      <Image
